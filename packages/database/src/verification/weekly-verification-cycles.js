...
exports.WeeklyVerificationCycleModel = void 0;
class WeeklyVerificationCycleModel {
    supabase;
    ...
    async updateStoreCount(id, total_stores, completed_stores) {
        const { data, error } = await this.supabase
            .from('weekly_verification_cycles')
...
exports.WeeklyVerificationCycleModel = WeeklyVerificationCycleModel;
//# sourceMappingURL=weekly-verification-cycles.js.map