...
// Streaming response types for real-time AI chat
...
export namespace AIAssistant {
  ...
  export type Message = AIConversationMessage;
  export type ContextEntry = BusinessContextEntry;
  export type Suggestion = AISuggestion;
  export type ValidationResult = ContextValidationResult;
  export type Error = AIAssistantError;
}