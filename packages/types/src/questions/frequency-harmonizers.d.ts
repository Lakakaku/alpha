...
export type ResolutionConfiguration = CombineStrategyConfig | PriorityStrategyConfig | AlternateStrategyConfig | CustomStrategyConfig;
...
export interface DetectConflictsRequest {
    ...
    conflict_threshold?: 'low' | 'medium' | 'high';
}
...
export interface HarmonizationEffectivenessReport {
    ...
    harmonizer_performance: Array<{
        ...
        effectiveness_metrics: {
            ...
            call_efficiency_improvement: number;
    ...
    overall_impact: {
        ...
        avg_call_time_reduction: number;
        question_redundancy_reduction: number;
...
//# sourceMappingURL=frequency-harmonizers.d.ts.map