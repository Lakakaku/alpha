...
**Relationships**: Extends business_stores (1:1), has layout_departments and layout_changes (1:many)
...
**Relationships**: Extends business_stores (1:1), has product_categories and special_services (1:many)
...
All context tables inherit business-level isolation from existing business_stores RLS:
